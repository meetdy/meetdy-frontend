...
function CallVideo(props) {
  ...
  const handleToggleVideo = () => {
    const isEnabled = myStreamRef.current.srcObject.getVideoTracks()[0].enabled;
  ...
  const handleToggleAudio = () => {
    const isEnabled = myStreamRef.current.srcObject.getAudioTracks()[0].enabled;
  ...
  return (
    <div id="call-video">
      ...
      <div className="local-video">
        ...
        <video ref={myStreamRef} autoPlay style={{ width: '100%' }} muted />
      </div>
